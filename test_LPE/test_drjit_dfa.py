...
result, states = jitDFA.transition_verification("DE")
print(result, states)


result, states = jitDFA.transition_verification("DDDDDDE")
print(result, states)


result, states = jitDFA.transition_verification("DDDAE")  # earlt stop at G
print(result, states)

result, states = jitDFA.transition_verification("DDDE")  # earlt stop at G
print(result, states)
...
# print("=========reverse=============")
# regex = "D*E"
# jitDFA2 = DrJitDFA(regex,True)
# result, states = jitDFA2.transition_verification("DE")
# print(result, states)
# result, states = jitDFA2.transition_verification("R")
# print(result, states)
# result, states = jitDFA2.transition_verification("RA")
# print(result, states)
# result, states = jitDFA2.transition_verification("RRRRRRE")
# print(result, states)

# print("=========================")
# print(jitDFA2.dfa.accept_node)
# for e in jitDFA2.dfa.edges:
#     print("origin: " + str(e.origin.node_ID)+" next: " +
#           str(e.next.node_ID) + " event: " + str(e.event))
# print("=========================")

# print("=========================")
# print(jitDFA.dfa.accept_node)
